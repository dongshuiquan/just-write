...
public class SFTPUtils
{
    ...
    public static void main(String[] args)
    {
        SFTPUtils sftp = null;
        // 本地存放地址
        String localPath = "D:/office/";
        // Sftp下载路径
        String sftpPath = "/home/dongshuiquan/";
        List<String> filePathList = new ArrayList<String>();
        try
        {
            sftp = new SFTPUtils("192.168.131.140", "dongshuiquan", "dong");
            sftp.connect();
            // 下载
            sftp.batchDownLoadFile(sftpPath, localPath, "", ".txt", false);
           // sftp.uploadFile(sftpPath, "aabb.txt", localPath, "b.txt");
