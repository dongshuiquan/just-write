...
public class ProxyVersion_2 implements Serializable
{
    ...
    public static Object newProxyInstance(Class<?> interfaces, InvocationHandler h) throws Exception
    {
        ...
        sb.append("package com.dsq.proxy;\n\n");
        ...
        String fileName = fileDir + "\\src\\main\\java\\com\\dsq\\proxy\\$Proxy1.java";
        ...
        Class<?> c = Class.forName("com.dsq.proxy.$Proxy1", false, ul);
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        System.out.println("动态生成代理耗时 2：" + (System.currentTimeMillis() - start) + "ms");
        helloWorld.print();
        System.out.println();
    }
}