...
public class StoreTable extends JTable {
    public StoreTable() {
        ...
        getTableHeader().setPreferredSize(new Dimension(getWidth(), 85));
...
//审核人   label=getLabel("审核人");
    ...
    public static void main(String[] args)
    {
        ...
        frame.setSize(800,300);  frame.setDefaultCloseOperation(3);
