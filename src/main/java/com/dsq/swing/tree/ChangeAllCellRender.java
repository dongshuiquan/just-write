...
public class ChangeAllCellRender
{
    ...
    public void init()
    {
        ...
        // 设置处于折叠状态下非叶子节点的图标。
        URL url = this.getClass().getClassLoader().getResource("icon/close.gif");
        ...
        // 设置叶子节点的图标。
        url = this.getClass().getClassLoader().getResource("icon/leaf.png");
        try {
            bufferedImage = ImageIO.read(url);
        } catch (IOException e) {
            e.printStackTrace();
        ...
        cellRender.setLeafIcon(icon);
        // 设置处于展开状态下非叶子节点的图标。
        url = this.getClass().getClassLoader().getResource("icon/open.gif");
        try {
            bufferedImage = ImageIO.read(url);
        } catch (IOException e) {
            e.printStackTrace();
