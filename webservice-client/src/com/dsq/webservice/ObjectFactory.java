 ...
 * generated in the com.dsq.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _TransWordsResponse_QNAME = new QName("http://webservice.dsq.com/", "transWordsResponse");
    private final static QName _TransWords_QNAME = new QName("http://webservice.dsq.com/", "transWords");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.dsq.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.dsq.com/", name = "transWordsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.dsq.com/", name = "transWords")
